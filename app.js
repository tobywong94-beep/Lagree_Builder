...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function parseTimeInput(val){
    ...
    if(parts.length===2){ const m = parseInt(parts[0],10)||0, s=parseInt(parts[1],10)||0; return m*60+s; }
